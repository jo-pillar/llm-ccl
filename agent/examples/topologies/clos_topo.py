...
topology = ClosTopology(
    ...
    layer0=LayerSpec(0, LinkSpec("32.5GBps", "9us"), group_num=8, node_num=8, node_type=NodeType.GPU),
    layer1=LayerSpec(1, LinkSpec("2.8125GBps", "25us"), group_num=8, node_num=1, node_type=NodeType.SWITCH),
    layer2=LayerSpec(2, LinkSpec("2.8125GBps", "25us"), group_num=2, node_num=4, node_type=NodeType.SWITCH),
    layer3=LayerSpec(3, LinkSpec("45GBps", "25us"), group_num=1, node_num=2, node_type=NodeType.SWITCH),
)
###TopoEND
